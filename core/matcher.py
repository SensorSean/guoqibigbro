...
STRICT_SYNONYMS = [
    ...
    # ⚠️「项目负责人」与「项目经理」在真实数据里是两列、两个不同的人，不可同组。
    # 旧版把二者连同 项目责任人/法人代表 并为一个组，导致目标列「项目负责人」在没有
    # 同名源列时被同义命中源列「项目经理」（_synonym_score 95.0）→ 整列填成错的人。
    # 现拆为互不隶属的独立组；「法人代表」「项目责任人」下方各自已有独立组，故不再并入。
    ["负责人", "项目负责人", "项目责任人"],
    ["项目经理", "项目经理人", "项目经手人"],
